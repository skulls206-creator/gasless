    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col relative overflow-hidden">
      ...
      <header className="relative z-10 sticky top-0 bg-background/60 backdrop-blur-md border-b border-white/5 py-4 px-6 flex justify-between items-center">
        <div className="flex items-center gap-3">
          <img src={`${import.meta.env.BASE_URL}images/logo.png`} alt="Logo" className="w-8 h-8 object-contain drop-shadow-md" />
          <h1 className="font-display font-bold text-xl tracking-tight text-gradient">TRON Wallet</h1>
        </div>
        <button 
          onClick={logout}
